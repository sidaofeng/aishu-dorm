...
import com.waken.dorm.service.dorm.SchoolCampusService;
 ...
 * @Description 校区模块相关接口
 * @Author zhaoRong
 * @Date 2019/3/31 12:35
 **/
@Slf4j
@Api(value = "校区相关接口", description = "校区模块相关接口(AiShu)")
@RestController
public class SchoolCampusController extends BaseController {
    @Autowired
